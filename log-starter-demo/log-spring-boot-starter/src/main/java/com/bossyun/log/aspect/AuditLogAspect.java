package com.bossyun.log.aspect;

import com.bossyun.log.annotation.AuditLog;
import com.bossyun.log.model.Audit;
import com.bossyun.log.properties.AuditLogProperties;
import com.bossyun.log.service.IAuditService;
...
public class AuditLogAspect {
    ...
    public void beforeMethod(JoinPoint joinPoint, AuditLog auditLog) throws IOException {
        //判断功能是否开启
     ...
     * 构建审计对象
     */
    private Audit getAudit(AuditLog auditLog, JoinPoint joinPoint) throws IOException {
