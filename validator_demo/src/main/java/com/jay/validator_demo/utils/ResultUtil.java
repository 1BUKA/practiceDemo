...
public class ResultUtil {
    ...
    public static boolean checkSuccessResultJsonBeanWithData(ResultJsonBean resultJsonBean){
        return resultJsonBean!=null && resultJsonBean.getCode()==200 && resultJsonBean.getData()!=null;
    }
