...
public enum ResultJsonEunm {
    ...
    *       */
    ...
    SUCCESS_WAIT(201, "请求成功，请等待结果"),//请求成功，但是需要等待执行结果
    ...
    ERROR_FOR_WX_PAY_ERROR(546, "微信支付失败"),//微信支付失败

    ERROR_FOR_BAIJIAYUN_ERROR(547, "请求百家云失败"),//请求百家云失败
    ...
    ERROR_FOR_USER_TOKEN_TIME_ERROR(705, "用户登录过期"),//用户登录过期

    ERROR_FOR_USER_EXIST(706, "用户已存在"),//用户已存在

    ERROR_FOR_USER_PHONE_ISNULL(707, "用户未绑定手机"),//用户未绑定手机

    ERROR_FOR_USER_LOGIN_CLIENT(708, "当前用户已在其他设备登录"),//当前用户已在其他设备登录

    ERROR_FOR_BUSINESS_INTERRUPT_ERROR(801, "中断业务操作"),//中断业务操作
